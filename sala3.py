...
class Game():
    ...
    def move_ball(self): 
        ...
        self.indexright = 0 #índice que recorre la lista de bolas auxiliar del jugador derecho
        self.indexleft = 0
        for ball in self.ballsrightaux:
            ...
            if pos[X]<0:
                ...
                self.ballsright.pop(self.indexright)
            self.indexright += 1
        ...
        for ball in self.ballsleftaux:
            ...
            if pos[X]>SIZE[X]:
                self.id_malos.append(ball.get_id())
                self.ballsleft.pop(self.indexleft)
            self.indexleft += 1
        self.lock.release()
